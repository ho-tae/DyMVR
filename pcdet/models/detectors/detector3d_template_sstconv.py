...
class Detector3DTemplate_sstconv(nn.Module):
    ...
    def build_vfe(self, model_info_dict):
        ...
        vfe_module = vfe.__all__[self.model_cfg.VFE.NAME](
            ...
            sub_voxel_size_low=self.model_cfg.TRAIN_CFG.sub_voxel_size_low,
            sub_voxel_size_med=self.model_cfg.TRAIN_CFG.sub_voxel_size_med,
            grid_size=model_info_dict['grid_size'],
            feat_channels=self.model_cfg.TRAIN_CFG.feat_channels,
        )
